...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://172.20.10.2/loginSystem/relay/getDataRelay.php");  //--> Specify request destination
    ...
    http.begin("http://172.20.10.2/loginSystem/relay/updateRELAYSdata_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
