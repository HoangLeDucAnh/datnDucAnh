...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://192.168.1.9/loginSystem/dht11_fan/getdata.php");  //--> Specify request destination
    ...
    http.begin("http://192.168.1.9/loginSystem/dht11_fan/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
