...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($duplicate) > 0) {
        ...
        if ($password == $confirmpassword) {
            // insert query
            $query = "INSERT INTO users VALUE('', '$name', '$username', '$email', '$password', 'user')";
...
<body>
        ...
        <div class="container-fluid gap-5">
            ...
            <div class="collapse navbar-collapse gap-5" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-5">
                    ...
                    <li class="nav-item">
                        <a id="user" class="nav-link" href="#">Users</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-2">
                    ...
                    <li>
                        <a class="logOut btn btn-outline-primary" href="index.php">Log In</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container pt10">
        ...
        <form method="post" autocomplete="off" class="py-2">
            ...
            <button type="submit" name="submit" class="btn btn-outline-primary py-2 my-5">Register</button>
        </form>
    </div>
